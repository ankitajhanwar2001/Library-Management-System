...
router.get('/admin-update-profile', middleware.isAdmin, function (req, res) {
  res.render('admin/update-profile.html');
})

//admin -> update profile
router.post("/admin/profile", middleware.isAdmin, adminController.postUpdateAdminProfile);

router.get('/admin-change-password', middleware.isAdmin, function (req, res) {
  res.render('admin/changePassword.html');
})
