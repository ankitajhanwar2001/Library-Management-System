...
router.get('/change-photo', middleware.isLoggedIn, function (req, res) {
  res.render('user/change-photo.html');
})
...
router.get('/change-password', middleware.isLoggedIn, function (req, res) {
  res.render('user/changePassword.html');
})
...
router.get('/update-profile', middleware.isLoggedIn, function (req, res) {
  res.render('user/update-profile.html');
})
...
// router.get('/delete-profile', middleware.isLoggedIn, function (req, res) {
//   res.render('user/delete-profile.html');
// })
